...
export interface DaemonRouteContext {
  ...
  readonly deliverSlackApprovalUpdate: (approval: SharedApprovalRecord, binding: import('../automation/routes.ts').AutomationRouteBinding) => Promise<void>;
  readonly deliverDiscordApprovalUpdate: (approval: SharedApprovalRecord, binding: import('../automation/routes.ts').AutomationRouteBinding) => Promise<void>;
  readonly deliverNtfyApprovalUpdate: (approval: SharedApprovalRecord, binding: import('../automation/routes.ts').AutomationRouteBinding) => Promise<void>;
  readonly deliverWebhookApprovalUpdate: (approval: SharedApprovalRecord, binding: import('../automation/routes.ts').AutomationRouteBinding) => Promise<void>;

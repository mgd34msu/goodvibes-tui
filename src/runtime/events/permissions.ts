...
export type PermissionEvent =
  ...
  | { type: 'PERMISSION_REQUESTED'; callId: string; tool: string; args: Record<string, unknown>; category: string }
  ...
  | { type: 'DECISION_EMITTED'; callId: string; tool: string; approved: boolean; source: string };

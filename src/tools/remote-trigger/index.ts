...
function summarizePool(pool: ReturnType<ReturnType<typeof getRemoteRunnerRegistry>['listPools']>[number]) {
  return {
    id: pool.id,
    label: pool.label,
...
function summarizeContract(contract: ReturnType<ReturnType<typeof getRemoteRunnerRegistry>['listContracts']>[number]) {
  return {
    id: contract.id,
...
function summarizeArtifact(artifact: ReturnType<ReturnType<typeof getRemoteRunnerRegistry>['listArtifacts']>[number]) {
  return {
    id: artifact.id,

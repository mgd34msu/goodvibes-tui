...
import { classifySegment, classifyCommand, higherPriority } from '@/runtime/index.ts';
import { canonicalize } from '@/runtime/index.ts';
import type { CommandSegment } from '@/runtime/index.ts';

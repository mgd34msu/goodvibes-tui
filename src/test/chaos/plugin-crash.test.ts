...
import { PluginLifecycleManager } from '@/runtime/index.ts';
import { isOperational, isReloadable, isTerminal, canTransition } from '@/runtime/index.ts';
import type { PluginManifestV2 } from '@/runtime/index.ts';

...
const ALTERNATE_VALUE: Record<string, unknown> = {
  ...
  'surfaces.email.inbound.accounts': '[{"id":"primary"}]',
  'surfaces.email.inbound.source': 'imap',
  'surfaces.email.inbound.gmailPollSecondsExpecting': 10,
  'surfaces.email.inbound.gmailPollSecondsIdle': 120,
  'surfaces.email.inbound.mode': 'poll',
  'surfaces.email.inbound.pollIntervalSeconds': 300,
  'surfaces.email.inbound.idleReissueMinutes': 20,
  'surfaces.email.inbound.reconnect.maxBackoffSeconds': 600,
  'surfaces.email.inbound.notice.route': 'telegram',
  'surfaces.email.inbound.notice.mode': 'expected-only',
  'surfaces.email.inbound.expectationWindowMinutes': 30,
  'surfaces.email.inbound.dedupTtlMinutes': 120,
  'surfaces.email.inbound.retentionDays': 90,
  'surfaces.email.inbound.maxRecords': 10_000,
  'surfaces.email.inbound.capabilityRecheckMinutes': 120,

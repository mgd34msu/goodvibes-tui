...
// directory (decongestion of the former workspace-migration.test.ts).
...
// here. (agent-logs-panel.contract.ts was removed under: AgentLogsPanel
// was merged into AgentInspectorPanel; ContextVisualizerPanel's contract
// module was folded into TokenBudgetPanel's by when the two panels
// merged.)
// ---------------------------------------------------------------------------

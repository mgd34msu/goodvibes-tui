...
// W6.1 (the purge) — group B: 6 more contract modules were removed with their
// panels' migration to config-modals (marketplace, hooks, security,
// knowledge-graph, memory, project-planning → modals under
// src/panels/modals/, golden-tested in ecosystem-modals-golden.test.ts).
// skills/plugins panel classes are retained (shared non-class exports) so
// their contract modules stay. Count dropped from 15 to 9.

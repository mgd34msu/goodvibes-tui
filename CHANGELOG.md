...
- **A dead subscription login is named as such.** An OpenAI subscription
...
- **Escaped errors are captioned honestly.** An unhandled rejection with no
  provider markers is reported as a GoodVibes bug; one carrying provider
  markers (a 5xx outage classifies as neither auth nor network) stays
  neutral instead of blaming either side.
- Platform runtime pins move to 2.0.21; the bundled daemon moves to 1.28.23.
...
- This repository's releases now carry the suite installer; the command at
  `https://goodvibes.sh/install.sh` is unchanged.
...
### Changes
- ce29b1dd chore: update sdk to 0.33.25
...
### Changes
- 8f989b6c Update SDK to 0.33.16

## [0.19.77] — 2026-05-08

### Changes
- e1b9d18d Update SDK to 0.33.15

## [0.19.76] — 2026-05-08

### Changes
- f541c42f Update SDK to 0.33.14
...
### Changes
- 817731ef chore: update goodvibes sdk to 0.33.12
...
### Changes
- f7dcf379 chore: update goodvibes sdk to 0.33.9
